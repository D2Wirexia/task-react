...
const Nav = (props) => {
	...
	let friendsData = props.sideBar.friends.map(x => {
			 ...
			 <div className={universal.post}>
				 ...
				 <div className={universal.blockFriend}>
					 <div className={universal.bestFriend}>
						 ...
						 <div className={universal.friend}>{friendsData[0]}</div>
					 </div>
					 <div className={universal.bestFriend}>
						 <div className={universal.photo}><img src={photoUlr}></img></div>
						 <div className={universal.friend}>{friendsData[1]}</div>
					 </div>
					 <div className={universal.bestFriend}>
						 <div className={universal.photo}><img src={photoUlr}></img></div>
						 <div className={universal.friend}>{friendsData[2]}</div>
					 </div>
				 </div>
